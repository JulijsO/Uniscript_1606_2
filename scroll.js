...
$(".main-container").on("scroll", function () {
    ...
    if (scrollPercentage >= 50 && scrollPercentage <= 55) {
        ...
        if (scrollIndex !== newScrollIndex) {
            scrollIndex = 18;
            $(".statement-container").empty();
            $(".statement-container").html(" <span class='statement19'>Schriftzeichen zu betrachten, die man nicht lesen kann, ist eine eigentuemliche Erfahrung.</span>");
        }
        ...
        if (scrollIndex !== newScrollIndex) {
            scrollIndex = 19;
            $(".statement-container").empty();
            $(".statement-container").html(" <span class='statement20'>Schriftzeichen zu betrachten, die man nicht lesen kann, ist eine eigentuemliche Erfahrung.</span>");
        }
    }    
